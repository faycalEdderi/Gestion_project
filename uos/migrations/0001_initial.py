# Generated by Django 2.2 on 2020-03-06 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DateDebutUO', models.DateTimeField(blank=True, default=datetime.datetime(2020, 3, 6, 7, 20, 27, 866715, tzinfo=utc))),
                ('DateLivraison', models.DateTimeField(blank=True, default=datetime.datetime(2020, 3, 6, 7, 20, 27, 866715, tzinfo=utc))),
                ...
                ('plateforme', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='uos.Plateforme')),
                ('pointage', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='uos.Pointage')),
