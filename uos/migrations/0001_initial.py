# Generated by Django 2.2.4 on 2020-04-01 13:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semaine', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 1, 13, 33, 45, 454602, tzinfo=utc), null=True)),
                ...
                ('point_executant', models.FloatField(validators=[django.core.validators.MinValueValidator(0.0), django.core.validators.MaxValueValidator(5)])),
                ('executant', models.ManyToManyField(default='', to='profil.Executant')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_debut_uo', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 1, 13, 33, 45, 456596, tzinfo=utc), null=True)),
                ('date_livraison', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 1, 13, 33, 45, 456596, tzinfo=utc), null=True)),
