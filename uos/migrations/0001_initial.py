# Generated by Django 2.2 on 2020-04-21 11:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_debut_uo', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 21, 11, 54, 59, 210000, tzinfo=utc), null=True)),
                ('date_livraison', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 21, 11, 54, 59, 210000, tzinfo=utc), null=True)),
                ('avancement_total', models.FloatField(blank=True, default=0, null=True)),
                ('Pointage_total', models.FloatField(blank=True, default=0, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semaine', models.DateTimeField(blank=True, default=datetime.datetime(2020, 4, 21, 11, 54, 59, 212000, tzinfo=utc), null=True)),
                ...
                ('user', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='profil.MyUsers')),
            ],
        ),
        migrations.CreateModel(
            name='Perimetre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uo', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='uos.Uo')),
                ('user', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, to='profil.Pilote')),
            ],
        ),
        migrations.AddField(
